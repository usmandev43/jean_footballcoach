...
- (IBAction)onHallOfFame:(id)sender {
  //  [self.navigationController pushViewController:[[HallOfFame alloc] init] animated:YES];
    
    HallOfFame *detailVC = [[HallOfFame alloc] init];
